...
nbrdata = 10_000 # the number of training data
...
"""
function prepocess(features,targets,L)
...
x_train,y_train = prepocess(features,targets,nbrdata)
features_test = testset.features
targets_test = testset.targets
x_test,y_test = prepocess(features_test,targets_test,10_000)
